$(document).ready(function(){
  // Initialize Firebase
  var config = {
    apiKey: "AIzaSyA7XEd-cgWsHtbHXbSAaeQrVTcwhP2V8Io",
    authDomain: "f2e1124-751ab.firebaseapp.com",
    databaseURL: "https://f2e1124-751ab.firebaseio.com",
    storageBucket: "f2e1124-751ab.appspot.com",
    messagingSenderId: "434790579562"
  };
  ...
  firebase.auth().onAuthStateChanged(function(user){
    if(user) {
      ...
      $age.on('value',function(snap){$profileAge.html(snap.val());});
      $occupation.on('value',function(snap){$profileOccupation.html(snap.val());});
      $descriptions.on('value',function(snap){$profileDescriptions.html(snap.val()); });
